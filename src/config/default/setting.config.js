...
module.exports = {
  ...
  layout: 'mix',                       //导航布局，可选 side:侧边导航,head:顶部导航,mix:顶部一级导航，侧边一级级以下菜单导航，
  ...
  systemName: 'Auto Admin',         //系统名称
  copyright: '2021 Karajan 简化版',     //copyright
  ...
  footerLinks: [                        //页面底部链接，{link: '链接地址', name: '名称/显示文字', icon: '图标，支持 ant design vue 图标库'}
    {link: 'https://pro.ant.design', name: 'ant design Pro首页'},
    {link: 'https://github.com/gomeDesign/autoadmin', icon: 'github'},
